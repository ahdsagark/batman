...
const EnglishModule = {
  ...
  renderEnglish() {
    ...
    // 1. English Logged Display
    const loggedEl = document.getElementById('english-today-logged');
    if (loggedEl) {
      const totalSecs = log.englishSeconds || 0;
      loggedEl.textContent = `Today: ${DateUtils.formatDurationHoursMins(totalSecs)} / 30m`;
    }

    // 2. Render IELTS Mock History
